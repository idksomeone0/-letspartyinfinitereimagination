...
This is a project that I've worked on for about two months, but I've come to see it's biting off more than I can chew so I decided to just post it on here for whoever might care, maybe I'll come back to it maybe I won't. Feel free to expand upon it or use it for something, although with due credit.
